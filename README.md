...
- [Courgette](https://courgette-testing.com) - Simple UI testing. Proper declarative BDD scenarios using Gherkin, Gherkin templates and composable YAML-style page and component objects.
